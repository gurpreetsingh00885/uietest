...
class TestResponse(models.Model):
    student = models.OneToOneField(
        Student, default=None, on_delete=models.CASCADE, blank=False)
...
class Answer(models.Model):
    ...
    response = models.ForeignKey(
        TestResponse, default=None, on_delete=models.CASCADE, blank=False)
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="not_visited")
    question = models.OneToOneField(
        Question, default=None, on_delete=models.CASCADE, blank=False)
